...
When a consumer controls the rate of consumption, it is impossible to overwhelm it. This is one of the {reactive-principles}/patterns/coordinate-dataflow.html[Reactive Patterns {tab-icon}, window="tab"]. Such flow control, though, must be managed end-to-end.
