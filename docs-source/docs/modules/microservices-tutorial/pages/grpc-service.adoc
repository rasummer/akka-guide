...
As an alternative, you can run the service in https://kubernetes.io/[Kubernetes {tab-icon}, window="tab"].
...
[.group-scala]
****
The version number of the image, as well as from the project itself, is derived from the git commit using https://github.com/sbt/sbt-dynver[sbt-dynver {tab-icon}, window="tab"]. If your project is not being versioned with git, you will see a fixed version number (eg: `HEAD-20210119-1515`). You can enable git for the directory with the following commands.
...
[source,json]
----
include::example$01-shopping-cart-service-scala/kubernetes/namespace.json[]
----
...
[source,yaml]
----
include::example$01-shopping-cart-service-scala/kubernetes/rbac.yml[]
----
...
[source,yaml]
----
include::example$01-shopping-cart-service-scala/kubernetes/deployment.yml[]
----
+
...
[source,yaml]
----
include::example$01-shopping-cart-service-scala/kubernetes/service.yml[]
----
